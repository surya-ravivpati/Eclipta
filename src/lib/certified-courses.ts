...
export const CERTIFIED_COURSES: CertifiedCourse[] = [
  {
    ...
    syllabus: [
      {
        title: "Foundations",
        lessons: ["Linear regression", "Logistic regression", "Loss & gradient descent"],
      },
      { title: "Classical ML", lessons: ["Decision trees", "Random forests", "SVMs", "k-NN"] },
      {
        title: "Neural Networks",
        lessons: ["Forward & backprop", "Activation functions", "Optimizers"],
      },
      { title: "Deep Learning", lessons: ["CNNs", "RNNs", "Transformers"] },
      {
        title: "Production",
        lessons: ["Model versioning", "Serving with FastAPI", "Monitoring drift"],
      },
    ],
  },
  {
    ...
    syllabus: [
      {
        ...
        lessons: ["Big-O refresher", "Amortized analysis", "P vs NP intuition"],
      },
      { title: "Graph Algorithms", lessons: ["BFS/DFS", "Dijkstra & A*", "Min-cost max-flow"] },
      {
        title: "Advanced Structures",
        lessons: ["Skip lists", "Tries", "Segment trees", "Persistent data structures"],
      },
      {
        title: "Interview Prep",
        lessons: ["DP patterns", "Greedy proofs", "System-design crossovers"],
      },
    ],
  },
  {
    ...
    rating: 4.9,
    outcomes: [
      "Understand qubits & superposition",
      "Write basic quantum circuits",
      "Grasp quantum advantage",
    ],
    ...
    syllabus: [
      {
        ...
        lessons: ["Vectors & inner products", "Tensor products"],
      },
  ...
  },
  {
    ...
    outcomes: [
      ...
      "Navigate real-world trade-offs",
    ],
    tags: ["Architecture", "Distributed Systems", "Databases"],
    description:
      "Designed for engineers preparing for L5/L6 interviews and architects scaling real systems. Every module ends with a live design challenge.",
    syllabus: [
  ...
  },
  {
    ...
    description:
      "Hands-on offensive security in a sandboxed lab. Every concept is paired with a CTF-style challenge.",
    syllabus: [
