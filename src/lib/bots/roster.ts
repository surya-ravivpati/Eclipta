...
export const PERSONALITIES: Record<PersonalityId, Personality> = {
  ...
  future_doctor: {
    ...
    archetypes: ["healer", "perfectionist" as ArchetypeId, "fulcrum"],
...
const HANDLE_HEADS = [
  "quanta", "lumen", "vector", "delta", "cipher", "prism", "atlas", "nova",
  "helix", "kappa", "orbit", "flux", "cobalt", "ember", "vertex", "photon",
  "tesla", "cosine", "quark", "zenith", "matrix", "pulsar", "sigma", "onyx",
  "axiom", "borealis", "cadmium", "dynamo", "echelon", "fathom", "gambit",
  "halcyon", "ionic", "juniper", "kelvin", "lattice", "meridian", "nimbus",
];

const HANDLE_TAILS = [
  "solves", "studies", "learns", "runs", "grinds", "codes", "thinks", "climbs",
  "iterates", "derives", "proves", "reads", "drafts", "builds", "tests",
];
...
const ACHIEVEMENTS = [
  "First Blood", "Ten Duels", "Fifty Duels", "Century", "Perfect Set",
  "Comeback", "Flawless Week", "Night Shift", "Early Bird", "Streak Keeper",
  "Subject Specialist", "Giant Slayer", "Marathon", "Quick Draw",
];
