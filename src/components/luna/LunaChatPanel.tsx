...
const BREAK_MESSAGE =
  "You've been pushing through tough spots. 🌙 How about a 5-minute break? Or we could switch to a battle for some fun?";
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-[10px] text-muted-foreground ml-2 tracking-widest">
                  AI TUTOR
                </span>
              </div>
            </div>
          ...
          <div
            ref={scrollRef}
            className="flex-1 overflow-y-auto px-4 py-3 space-y-3 min-h-[160px] max-h-[min(360px,55vh)]"
          >
            ...
            {messages.map((msg, i) => (
              ...
              >
                ...
                >
                  ...
                  {msg.content && <LunaMarkdown>{msg.content}</LunaMarkdown>}
                  {msg.role === "assistant" && msg.actions && msg.actions.length > 0 && (
                    <LunaActions
                      actions={msg.actions}
                      onSendBack={(t) => send({ text: t, image: null })}
                    />
                  )}
                  {msg.role === "assistant" &&
          ...
          <div className="px-3 py-2 border-t border-border">
            ...
            {pendingImage && (
              <div className="mb-2 flex items-center gap-2 p-1.5 border border-neon-cyan/30 bg-neon-cyan/5 rounded">
                ...
                />
                <span className="text-[10px] font-bold tracking-widest text-neon-cyan flex-1">
                  SCREEN ATTACHED
                </span>
                <button
                  type="button"
            ...
            >
              ...
              <input
                ...
                className="flex-1 bg-secondary/30 border border-input rounded-sm px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-neon-purple"
              />
              <button
                type="submit"
