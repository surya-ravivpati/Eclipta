...
export const SEED_GROUPS: SeedGroup[] = [
  { slug: "grp-calculus", name: "Calculus Study Room", topic: "Calculus", goalText: "Work through derivatives, integrals and series together.", axis: "subject", isPublic: true },
  { slug: "grp-linear-algebra", name: "Linear Algebra", topic: "Linear Algebra", goalText: "Matrices, eigenvalues and the geometry behind them.", axis: "subject", isPublic: true },
  { slug: "grp-organic-chem", name: "Organic Chemistry", topic: "Organic Chemistry", goalText: "Mechanisms, synthesis routes and naming.", axis: "subject", isPublic: true },
  { slug: "grp-cell-biology", name: "Cell Biology", topic: "Biology", goalText: "Respiration, photosynthesis, division and genetics.", axis: "subject", isPublic: true },
  { slug: "grp-mechanics", name: "Physics: Mechanics", topic: "Mechanics", goalText: "Forces, momentum, energy and rotational motion.", axis: "subject", isPublic: true },
  { slug: "grp-algorithms", name: "Algorithms & Data Structures", topic: "Computer Science", goalText: "Complexity, graphs, dynamic programming and interview prep.", axis: "subject", isPublic: true },
  { slug: "grp-world-history", name: "World History", topic: "History", goalText: "Causes, consequences and essay structure.", axis: "subject", isPublic: true },

  { slug: "grp-ap-calc-bc", name: "AP Calculus BC", topic: "AP Calculus BC", goalText: "Timed practice and free-response technique.", axis: "exam", isPublic: true },
  { slug: "grp-ap-bio", name: "AP Biology", topic: "AP Biology", goalText: "Unit review and data-analysis questions.", axis: "exam", isPublic: true },
  { slug: "grp-sat-math", name: "SAT Math", topic: "SAT Math", goalText: "Pacing drills and the question types that catch people out.", axis: "exam", isPublic: true },
  { slug: "grp-tech-interview", name: "Technical Interview Prep", topic: "Interviews", goalText: "Mock interviews, complexity questions and talking through your reasoning.", axis: "exam", isPublic: true },

  { slug: "grp-first-year", name: "First-Year Undergrads", topic: "General", goalText: "Adjusting to university-level workload.", axis: "grade", isPublic: true },
  { slug: "grp-high-school", name: "High School", topic: "General", goalText: "Coursework, revision and exam season.", axis: "grade", isPublic: true },

  { slug: "grp-night-shift", name: "Night Shift", topic: "General", goalText: "For people whose best hours are after midnight.", axis: "interest", isPublic: true },
  { slug: "grp-streak-club", name: "Streak Club", topic: "General", goalText: "Daily accountability — one session a day, every day.", axis: "interest", isPublic: true },
  { slug: "grp-maths-olympiad", name: "Maths Olympiad", topic: "Competition Maths", goalText: "Problems that do not have a formula to plug into.", axis: "interest", isPublic: true },
];
