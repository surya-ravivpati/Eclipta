...
const ARCHETYPES: Record<ArchetypeKey, MonsterArchetype> = {
  speedster: {
    ...
    special: "Damage scales with time remaining",
  },
  tank: {
    id: "tank",
    name: "Tank",
  ...
  chud: {
    ...
    special: "Below 35 HP gains +30% damage",
  },
  gambler: {
    id: "gambler",
    name: "Gambler",
    ...
    special: "All stats reroll each match",
  },
  healer: {
    id: "healer",
    name: "Healer",
    ...
    special: "Heal also grants an 8 HP shield",
  },
  fulcrum: {
    id: "fulcrum",
    name: "Fulcrum",
    ...
    special: "Copies a random passive each round",
  },
  accelerator: {
    id: "accelerator",
    name: "Accelerator",
    ...
    special: "+2 DMG and +2% score per correct answer",
  },
  god: {
    id: "god",
    name: "God",
    ...
    special: "Every 3 correct answers heals 15 HP",
  },
};
