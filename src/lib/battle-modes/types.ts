...
export const GAME_MODES: Record<GameModeId, GameModeDef> = {
  ...
  territory: {
    ...
    description:
      "A 5x5 board sits between you. Every correct answer plants one flag on any open tile - trap a line of enemy flags between two of yours and the whole line turns. Hit harder and your flag counts for more. Most territory wins.",
    effects: [
