  ...
  head: () => ({
    meta: [
      { title: "Build a Course - Eclipta" },
      {
        name: "description",
        content:
          "Create and share your own learning courses on Eclipta. Choose a topic, set your level, and design the perfect learning path.",
      },
      { property: "og:title", content: "Build a Course - Eclipta" },
      {
        property: "og:description",
        content: "Create and share your own learning courses on Eclipta.",
      },
    ],
  }),
